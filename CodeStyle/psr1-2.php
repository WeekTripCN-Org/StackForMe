    ...
    */
     ...
     */
     public $nameTest = ''; // 属性名称建议开头小写驼峰
                            // 成员属性必须添加public, private, protected 修饰符
     ...
     * @var string
     */
     private $_privateNameTest = ''; // 类私有成员属性，下划线小写开头驼峰
      ...
      */
      public function __construct($value = '') // 修饰符不能省略
      { // {}必须换行
       ...
       */
        ...
        * 返回值类型：string,array,object,mixed(多种，不确定的),void(无返回值)
        */
        private function _privateTestFunction($value = '') // 私有成员方法 下划线小写开头驼峰
        {
          // code...
        }
